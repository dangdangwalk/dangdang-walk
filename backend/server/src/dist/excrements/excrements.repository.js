"use strict";
Object.defineProperty(exports, "ExcrementsRepository", {
    enumerable: true,
    get: function() {
        return ExcrementsRepository;
    }
});
...
let ExcrementsRepository = class ExcrementsRepository extends _abstractrepository.AbstractRepository {
    constructor(excrementsRepository, entityManager){
        super(excrementsRepository, entityManager);
    }
};
ExcrementsRepository = _ts_decorate([
    _ts_param(0, (0, _typeorm.InjectRepository)(_excrementsentity.Excrements)),
