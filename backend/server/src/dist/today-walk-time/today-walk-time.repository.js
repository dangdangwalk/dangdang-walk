"use strict";
Object.defineProperty(exports, "TodayWalkTimeRepository", {
    enumerable: true,
    get: function() {
        return TodayWalkTimeRepository;
    }
});
...
let TodayWalkTimeRepository = class TodayWalkTimeRepository extends _abstractrepository.AbstractRepository {
    constructor(todayWalkTimeRepository, entityManager){
        super(todayWalkTimeRepository, entityManager);
    }
};
TodayWalkTimeRepository = _ts_decorate([
    (0, _common.Injectable)(),
    _ts_param(0, (0, _typeorm.InjectRepository)(_todaywalktimeentity.TodayWalkTime)),
