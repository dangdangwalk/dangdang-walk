export declare const VALID_ACCESS_TOKEN_100_YEARS =
...
export declare const INVALID_USER_ID_ACCESS_TOKEN =
...
export declare const EXPIRED_ACCESS_TOKEN =
...
export declare const MALFORMED_ACCESS_TOKEN = 'malformed_access_token';
export declare const VALID_REFRESH_TOKEN_100_YEARS =
...
export declare const EXPIRED_REFRESH_TOKEN =
...
export declare const MALFORMED_REFRESH_TOKEN = 'malformed_refresh_token';
export declare const VALID_PROVIDER_KAKAO = 'kakao';
export declare const INVALID_PROVIDER = 'invalid_provider';
export declare const AUTHORIZE_CODE = 'authorizeCode';
export declare const OAUTH_ACCESS_TOKEN = 'oauth_access_token';
export declare const OAUTH_REFRESH_TOKEN = 'oauth_refresh_token';
